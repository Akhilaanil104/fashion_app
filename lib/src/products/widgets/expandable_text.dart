...
class ExpandableText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(text,textAlign:TextAlign.justify ,maxLines: !context.watch<ProductNotifier>().description ?3:10,
        ...
        Row(
          ...
          children: [
            ...
            child: Text(context.watch<ProductNotifier>().description?"Read More":"View Less",style: appStyle(11, Kolors.kPrimaryLight, FontWeight.normal),),
